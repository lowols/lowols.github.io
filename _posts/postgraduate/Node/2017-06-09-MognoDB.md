...
对于`Windows`下的安装我觉得还是很烦的，这个平台对开发者真的不太友好呀。我觉得最好还是查看官方的安装教程: [MongoDB Window平台安装](http://docs.mongodb.com/manual/tutorial/install-mongodb-on-windows/)，网上有很多安装教程，很多我都觉得是一知半解，就把教程搬上来，还是不太建议。
...
+ [edX的MongoDB课程](http://courses.edx.org/courses/course-v1:MongoDBx+M101x+2T2016/info)
