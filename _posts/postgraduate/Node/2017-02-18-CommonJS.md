...
AMD(Asynchronous Module Definition)，中文介绍在这里： [http://github.com/amdjs/amdjs-api/wiki/AMD](http://github.com/amdjs/amdjs-api/wiki/AMD)
...
关于`CMD`的介绍，可以参考`Sea.js`的介绍：[http://github.com/seajs/seajs/issues/242](http://github.com/seajs/seajs/issues/242)。具体不推荐使用。

## 驼峰式命名法

![驼峰式命名来源](http://upload.wikimedia.org/wikipedia/commons/thumb/e/ef/CamelCase.svg/368px-CamelCase.svg.png)
