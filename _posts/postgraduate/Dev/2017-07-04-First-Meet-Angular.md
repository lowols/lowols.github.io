...
> One framework. Mobile & desktop.<sup>[来源](http://angular.io/)</sup>

而Angular是什么呢？我看到这句话

> Angular is a platform that makes it easy to build applications with the web. Angular combines declarative templates, dependency injection, end to end tooling, and integrated best practices to solve development challenges.<sup>[来源](http://angular.io/docs)</sup>

上面说，Angular是一个框架，还整合了声明式模板、依赖注入和端对端工具。具体点呢？

<!-- more -->

> Angular is a framework for building client applications in HTML and either JavaScript or a language like TypeScript that compiles to JavaScript.<sup>[来源](http://angular.io/guide/architecture)</sup>
...
学了Angular，还是非常建议[官方网站](http://angular.io/)。
