...
好。现在我们完整的代码已经上传至 [react-webpack-es6-jsx](https://github.com/lowols/react-webpack-es6-jsx)。
...
代码放在 [react-webpack-es6-jsx](https://github.com/lowols/react-webpack-es6-jsx/tree/hmr) 的 `hmr` 分支上。
