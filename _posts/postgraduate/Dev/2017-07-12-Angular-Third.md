...
为了学习Angular，实现了主页教程的`Heroes`例子。代码放在仓库[Angular4-heroes](http://github.com/lowols/Angular4-heroes)下。但是，希望写单独为此写一篇的目的在于，这是一个非常好的例子，通过这个例子，我们可以详细地了解Angular有关**表单**、**服务**、**注入**、**HTTP**、**路由**等概念，所以非常值得初学者学习。
...
> Routing is another name for navigation. The router is the mechanism for navigating from view to view<sup>[来源](http://www.angular.cn/docs/ts/latest/tutorial/toh-pt5.html)</sup>.
