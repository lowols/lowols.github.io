...
**如何学习TypeScript？**目前我推荐的是[官方的语言主页](http://www.typescriptlang.org/index.html)和该语言开源仓库的[wiki主页](http://github.com/Microsoft/TypeScript/wiki)，我尤其推荐后者，非常便于学习和查询。

<!-- more -->

**为啥我会学习TypeScript呢？**因为最近在学习[`Angular 2`](http://angular.io/)，而且TypeScript是开发`Angular 2`的官方语言。
...
> 这个图是我所修改过的，原图还有介绍了[AtScript](http://docs.google.com/document/d/11YUzC-1d0V1-Q3V0fQ7KSit97HnZoKVygDxpWzEYW0U/mobilebasic?viewopt=127)，它由Google开发，定义为TypeScript的超集。但目前已经全部整合进TypeScript，促进相互合作，促进大一统，Google也是放下了面子。
...
通常来讲，我们会将TypeScript代码转换到ES5代码，唯一的一个转换器是由TypeScript核心团队编写的，也集成到[typescript](http://www.npmjs.com/package/typescript)包当中。将`ES6`转换到`ES5`，通常使用社区创建的[`Babel`](http://babeljs.io/)。
...
有位大神编写了一个小工具，叫做[`TSUN`](http://github.com/HerringtonDarkholme/typescript-repl)(TypeScript Upgraded Node)。类似于一个升级版的Node，提供控制台程序书写。
...
这个听起来也好棒，不过并非我想折腾的。所以，需要的伙伴们可以参看这个链接: [Click me](http://github.com/nshen/ts-node-vscode-starter)
