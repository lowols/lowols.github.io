...
文章翻译自[CSS-TRICKS](http://css-tricks.com/)的[A Complete Guide to Flexbox](http://css-tricks.com/snippets/css/a-guide-to-flexbox/)。本译文会在不破坏原文的基础上进行删除和修正。
...
> Note: 弹性盒布局最适合应用组件或者小型布局，而[网格布局](http://css-tricks.com/snippets/css/complete-guide-grid/)(Grid)则是为大型布局设计的。
...
<p data-height="265" data-theme-id="light" data-slug-hash="LLvNyY" data-default-tab="html,result" data-user="maoxiake" data-embed-version="2" data-pen-title="a flex example" class="codepen">See the Pen <a href="http://codepen.io/maoxiake/pen/LLvNyY/">a flex example</a> by lowols (<a href="http://codepen.io/maoxiake">@maoxiake</a>) on <a href="http://codepen.io">CodePen</a>.</p>
