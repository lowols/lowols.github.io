...
JavaScript 颇让费解的东西 this 为何出现呢，机制是**提供更优雅的方式来隐式地“传递”一个对象引用**。对于 this 的很多误解和使用，建议收看 [You-Dont-Know-JS](http://github.com/getify/You-Dont-Know-JS)。本文主要是在它的基础上整合的内容。
...
console.log(per); // { who: 'walon', what: 'love', how: 'yuer' }
...
+ 《You Don't Know JS》
+ 《JavaScript 高级程序设计》
+ [不用call和apply方法模拟实现ES5的bind方法](http://github.com/jawil/blog/issues/16)
+ [JavaScript深入之new的模拟实现](http://github.com/mqyqingfeng/Blog/issues/13)